...
//
//     final appointmentDoctorDetails = appointmentDoctorDetailsFromJson(jsonString);

import 'dart:convert';

AppointmentDoctorDetails appointmentDoctorDetailsFromJson(String str) =>
    AppointmentDoctorDetails.fromJson(json.decode(str));

String appointmentDoctorDetailsToJson(AppointmentDoctorDetails data) =>
